    ...
    <table width="90%" border="0">
        ...
        <tr>
            ...
            <td width="25%" align="center">
               <img style="width: 160px; float: center; margin-top:-44px; margin-left:90px;" src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('theme/images/AVC-Stamp.png'))) }}" alt="">
            </td>
