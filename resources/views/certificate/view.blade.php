    ...
    <table width="90%" border="0">
        ...
        <tr>
            ...
            <td width="25%" align="center">
               <img style="width: 160px; float: center; margin-top:-25px; margin-left:120px;" src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('theme/images/stamp.png'))) }}" alt="">
            </td>
