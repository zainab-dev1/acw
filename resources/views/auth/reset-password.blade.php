            ...
            <div class="login-content">
                        ...
                        <div class="login-form">
                            ...
                            {{ Form::open(['route'=>'password.update', 'method' => 'POST']) }}
                                ...
                                <div class="form-group">
                                    <label style="font-weight: 600; color: #1e293b; margin-bottom: 8px;">New Password</label>
                                    <input type="password" class="form-control" name="password" placeholder="Enter new password" required>
                                </div>
                                
                                <div class="form-group">
                                    <label style="font-weight: 600; color: #1e293b; margin-bottom: 8px;">Confirm Password</label>
                                ...
                                <button type="submit" class="btn btn-primary btn-flat m-b-30 m-t-30 btn-block">
                                    <i class="ti-check"></i> Reset Password
                                </button>
