...
class VisitActivityTypesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('visit_activity_types')->delete();
        
        \DB::table('visit_activity_types')->insert(array (
            0 => 
            array (
                'id' => 1,
                'name' => 'Guest Lecture',
            ...
            array (
                'id' => 5,
            'name' => 'Industrial Research (By Staff)',
                'created_at' => NULL,
                'updated_at' => NULL,
            ),
            5 => 
